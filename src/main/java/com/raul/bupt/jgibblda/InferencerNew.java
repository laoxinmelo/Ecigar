...
public class InferencerNew {	
	// Train model
	public ModelNew trnModel;
	public Dictionary globalDict;
	private LDACmdOption option;
	
	private ModelNew newModel;
...
//		this.option = option;
		trnModel = new ModelNew();
		trnModel.dir = modelDir;
		
		if (!trnModel.initEstimatedModel(modelDir))
			return false;		
...
//		newModel.saveModel(newModel.dfile + "." + newModel.modelName);
	...
	public ModelNew inference(String [] strs, String modelDir)throws IOException{
		...
		return inference(dataset, modelDir);
	}
/*	
